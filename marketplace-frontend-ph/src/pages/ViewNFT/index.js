...
import acenttoken from '../../assets/img/icons/acent-icon.svg';
                  ...
                  <h4 className="nft-card__xdr mb-3">
                    <div className="d-flex flex-row justify-content-between flex-lg-wrap flex-nowrap mt-2">
                      <div className="d-flex align-items-center text-white w-100">
                        <TokenIcon src={myNft.currency ? bnbIcon : acenttoken} className="me-2" />
                      ...
                      <div className="row mt-3">
                        <div className="col-md-6 col-lg-6 col-sm-12">
                          ...
                          <p className="mb-0">
                            ...
                            {myNft.price} {myNft.currency ? 'BNB' : 'ACENT'}
                          </p>
                        </div>
