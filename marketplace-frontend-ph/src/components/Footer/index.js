        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-3 text-center">
            <ul className="list-inline social-nav">
              <li className="list-inline-item">
                <a href="https://twitter.com/AcentToken" target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-twitter"></i>
                </a>
              </li>
              <li className="list-inline-item">
                <a href="https://t.me/acentchat" target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-telegram-plane"></i>
                </a>
              </li>
              <li className="list-inline-item">
                <a
                  href="https://www.reddit.com/r/AcentOfficial/"
                  target="_blank"
              ...
              <li className="list-inline-item">
                <a
                  href="https://www.instagram.com/acenttoken/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
